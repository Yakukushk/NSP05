    ...
    <main>
      ...
      <section v-for="item in tabContent" :key="item.id">
        ...
        <div>
          ...
          <div v-if="uid === 1">
            <v-container>
              <h5 class="text-h5 text-center"><a href="https://apostille.minjust.gov.ua/">https://apostille.minjust.gov.ua/</a>
              </h5>
            </v-container>
          </div>
          <div v-if="uid === 2">
            <v-container>
              <h5 class="text-h5 text-center"><a
                  href="https://wanted.mvs.gov.ua/test">https://wanted.mvs.gov.ua/test</a></h5>
            </v-container>
          </div>
          <section style="background: #0c4a60" v-if="uid === 0">
            <v-container>
              <v-row no-gutters>
                ...
                <v-col>
                  <span class="fw-medium" style="color: whitesmoke;">1. {{ $t(item.step.text2) }} <a
                      href="https://vytiah.mvs.gov.ua/app/checkStatus">https://vytiah.mvs.gov.ua/app/checkStatus</a></span>
