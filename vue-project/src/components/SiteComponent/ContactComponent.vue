    ...
    <v-container>
      <v-row>
        <v-col order="2">
          ...
          <h3 class="">{{ $t('carouselComponent3.subtitle') }}</h3>
          <h3>{{ $t('formContact.userEmail') }} - <a
          ...
          <h3>{{ $t('formContact.userPhone') }} +380 97 169 37 37</h3>
        ...
        <v-col>
          ...
          <form @submit.prevent="sendMessage">
            <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label fw-medium">{{ $t('formContact.userName') }}</label>
              <input v-model="formValues.userName" type="name" class="form-control" id="exampleFormControlInput1"
                     placeholder=''>
            </div>

            <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label fw-medium">{{ $t('formContact.userPhone')}}</label>
              <input v-model="formValues.userPhone" type="number" class="form-control" id="exampleFormControlInput1"
                     placeholder='+380'>
            </div>
            <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label fw-medium">{{ $t('formContact.userEmail')}}</label>
              <input v-model="formValues.userEmail" type="email" class="form-control" id="exampleFormControlInput1"
                     placeholder="name@example.com">
            </div>
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label fw-medium">{{ $t('formContact.userSelect') }}</label>
            ...
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label fw-medium">{{ $t('formContact.userSubject') }}</label>
              <input v-model="formValues.userSubject" class="form-control" id="exampleFormControlTextarea1" rows="3"/>
            </div>
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label fw-medium">{{ $t('formContact.userMessage') }}</label>
              <textarea v-model="formValues.textArea" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
            </div>
